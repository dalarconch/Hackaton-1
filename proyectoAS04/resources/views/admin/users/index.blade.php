                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach($users as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td><a href="{{ url('/admin/users', $item->id) }}">{{ $item->nombre }}</a></td><td>{{ $item->email }}</td>
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/users/' . $item->id . '/edit') }}" title="Editar Usuario"><button class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i></button></a>
                                            {!! Form::open([
                                                'method' => 'DELETE',
